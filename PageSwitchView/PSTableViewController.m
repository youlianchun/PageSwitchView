...
@interface PSTableViewController ()<UITableViewDelegate,UITableViewDataSource,PageViewControllerProtocol,RefresDataArrayDelegate>
@property (nonatomic) RefresBranchdDataArray *dataArray;
@end

@implementation PSTableViewController

-(void)viewDidAdjustRect {
    self.dataArray = [RefresBranchdDataArray arrayWithRefresView:self.tableView delegate:self];
    PSViewController *parentVC = (PSViewController*)self.parentViewController;
    [parentVC.dataArray addBranchd:self.dataArray];
